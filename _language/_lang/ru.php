...
store_version_name=Шаблон: Модуль языка  
store_version_description=Пример модуля интеграции языка, разработанного для реализации в модуле Suitefish Administrator.  
