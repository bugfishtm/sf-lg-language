...
store_version_name=Modelo: Módulo de Idioma  
store_version_description=Exemplo de um módulo de integração de idioma projetado para implementação dentro do módulo Suitefish Administrator.  
