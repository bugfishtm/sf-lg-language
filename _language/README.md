...
You may download the example module here: [Download](https://github.com/bugfishtm/sf-lg-language)
...
This file (version.php) contains detailed information about the module, all variables are mandatory and should be set on a module. For detailed information on the file structure and module setup.
